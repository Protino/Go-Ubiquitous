package com.calgen.prodek.sunshine_v2.sync;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            long yesterday = currentTime - DAY_IN_MILLIS;
    ...
    private void notifyWeather() {
        ...
        if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
            ...
            if (cursor.moveToFirst()) {
                ...
                //add content to the notification UI
                ...
                //create pending intent and handle back presses by creating back stack
                Intent detailActivityIntent = new Intent(getContext(), DetailActivity.class);
                detailActivityIntent.setData(WeatherContract.WeatherEntry.buildWeatherLocationWithDate(locationQuery, date));
