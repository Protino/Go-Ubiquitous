...
package io.github.protino.sync;
...
import io.github.protino.BuildConfig;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public static final String ACTION_DATA_UPDATED = "io.github.protino.ACTION_DATA_UPDATED";
            ...
            if (forecastJson.has(OWM_MESSAGE_CODE)) {
                ...
                switch (errorCode) {
                    ...
                    case HttpURLConnection.HTTP_FORBIDDEN:
                        Log.e(LOG_TAG, "getWeatherDataFromJson: INVALID API_KEY");
                        setLocationStatus(getContext(), LOCATION_STATUS_SERVER_INVALID);
                        return;
                    default:
                        setLocationStatus(getContext(), LOCATION_STATUS_SERVER_DOWN);
                ...
                if (cursor.moveToFirst()) {
                    ...
                    NotificationCompat.Builder mBuilder =
                            new NotificationCompat.Builder(getContext())
                                    .setColor(getContext().getResources().getColor(R.color.colorPrimaryLight))
                                    .setSmallIcon(iconId)
