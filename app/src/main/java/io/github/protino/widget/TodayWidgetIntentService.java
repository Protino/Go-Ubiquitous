package io.github.protino.widget;
...
public class TodayWidgetIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            views.setTextViewText(R.id.widget_high_temp, formattedMaxTemperature);
            views.setTextViewText(R.id.widget_low_temp, formattedMinTemperature);
